...
class MainClass {
  public static void Main (string[] args) {
    ...
    var ss3 = from student in list                // list: must be IEnumerable<T> type
              where student.Height < 175          // condition
              orderby student.Height
              select student;                     // ss2: IEnumerable<Student>
    Console.WriteLine(ss3.Stringify() == "JJ Steve Won");

    var ss4 = from student in list                // list: must be IEnumerable<T> type
              where student.Height < 175          // condition
              orderby student.Height descending
              select student;                     // ss2: IEnumerable<Student>
    Console.WriteLine(ss4.Stringify() == "Won Steve JJ");

    var ss5 = from student in list                // list: must be IEnumerable<T> type
              where student.Height < 175          // condition
              orderby student.Height descending
              select student.Name;                // ss2: IEnumerable<string>
    Console.WriteLine(ss5.Stringify() == "Won Steve JJ");

    var ss6 = from student in list                // list: must be IEnumerable<T> type
              where student.Height < 175          // condition
              orderby student.Height
